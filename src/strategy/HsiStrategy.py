...
def algo_container_bull():
    ...
    fig = px.line(equity_curve_df,title='Equity Curve for HSI Strategy (Bull) - 2017/09/04 to 2017/11/22')
    fig.show()
...
def algo_container_bear():
    ...
    fig = px.line(equity_curve_df, title='Equity Curve for HSI Strategy (Bear) - 2021/06/07 to 2021/09/05')
    fig.show()
